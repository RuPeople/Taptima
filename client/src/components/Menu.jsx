            ...
            >
                ...
                <SocialsWrapper>
                    <motion.span
                        initial={{translateX: 1000}}
                        animate={{translateX: 0}}
                        transition={{duration: 0.44}}>Мы в соц. сетях:
                    </motion.span>
                    <div>
                        <motion.a
                            initial={{translateX: 1000}}
