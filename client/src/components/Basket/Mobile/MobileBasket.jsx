...
import {Wrapper, Ul, Head, BasketItem} from "./Styles";
                        ...
                        <div>
                            ...
                            <button onClick={
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" viewBox="0 0 25 25"
                                    ...
                                    <circle cx="12.5" cy="12.5" r="12" fill="white" stroke="#5DAAFF"/>
                                    <path
                                        d="M19 8.70992H17.874V17.5768C17.8732 17.954 17.7088 18.3155 17.4168 18.5823C17.1249 18.849 16.7292 18.9992 16.3163 19H8.67706C8.26388 18.9992 7.86783 18.8491 7.57536 18.5825C7.28288 18.3158 7.11775 17.9543 7.11599 17.5768V8.70992H6V8.16067H10.5669V6.84065C10.5674 6.7291 10.592 6.61872 10.6394 6.51593C10.6869 6.41313 10.7561 6.31995 10.8432 6.24177C10.9304 6.1636 11.0336 6.10199 11.1469 6.0605C11.2603 6.01902 11.3815 5.99848 11.5036 6.00009H13.5296C13.7734 6.00089 14.0069 6.0897 14.1792 6.24717C14.3516 6.40463 14.4488 6.61797 14.4497 6.84065V8.16067H19V8.70992Z"
                                        fill="#5DAAFF"/>
                                    <path
                                        d="M7.72363 17.5767C7.72451 17.8088 7.82603 18.0311 8.00595 18.1949C8.18587 18.3587 8.42952 18.4507 8.68352 18.4507H16.3228C16.5768 18.4507 16.8204 18.3587 17.0003 18.1949C17.1803 18.0311 17.2818 17.8088 17.2826 17.5767V8.70984H7.72363V17.5767ZM14.6322 10.039H15.2333V17.1216H14.6322V10.039ZM12.2009 10.039H12.7987V17.1216H12.2009V10.039ZM9.7663 10.039H10.3675V17.1216H9.7663V10.039Z"
                                        fill="white"/>
                                    <path
                                        d="M13.8285 6.84068C13.8285 6.7602 13.7935 6.68302 13.7312 6.62611C13.6689 6.5692 13.5845 6.53723 13.4964 6.53723H11.5035C11.4154 6.53723 11.331 6.5692 11.2687 6.62611C11.2064 6.68302 11.1714 6.7602 11.1714 6.84068V8.1607H13.8285V6.84068Z"
                                        fill="white"/>
                                </svg>
                            </button>
                        </div>
